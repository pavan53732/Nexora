...
1. **Sandbox denial** (`security/SandboxPolicy.md`): Interaction is denied by the authorization classifier as `NXR-2003` with subreason `CLASSIFIER_DENIAL`. This preserves the documented denial, audit, notification, isolation, and continuation behavior.
