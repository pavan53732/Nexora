...
1. **Sandbox denial** (`security/SandboxPolicy.md`): Interaction is denied. The canonical blocked-app error identity is OPEN/DEFERRED; this does not alter the documented denial, audit, notification, isolation, or continuation behavior.
