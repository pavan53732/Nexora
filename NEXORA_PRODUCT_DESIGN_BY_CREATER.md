...
| Network and egress | Network is denied unless authorized; guest egress uses the workspace proxy and fails closed on bypass or unsafe TLS | `security/SandboxPolicy.md:62-72` |
