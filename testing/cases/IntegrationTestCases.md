...
| IT-ESC-003 | IT-ESC | Task-scoped Terminal escalation passes matrix, permission, approval, classifier, sandbox, schema, timeout, and resource gates | Terminal + Security | Planned | `evidence/integration/IT-ESC-003/` | 2026-08-15 |
| IT-ESC-004 | IT-ESC | Task-scoped Background escalation validates checkpoint, progress, notification, cancellation, Android lifecycle, and degradation prerequisites | Background Runtime + Security | Planned | `evidence/integration/IT-ESC-004/` | 2026-08-15 |
