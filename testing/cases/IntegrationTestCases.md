...
| IT-TERM-001 | IT-TERM | Background TerminalSession inherits parent identity/deadline and reconciles cancellation, terminal parent, expiry, restart, and bounded cleanup failure without reattachment; after cleanup/termination exhaustion or unproven completion, commits existing `Failed`, surfaces derived user-visible `Manual cleanup required`, retains process/session references, cleanup evidence, deadline/retry data, and audit disposition, and permits no reattachment, replay, adoption, or reparenting | Terminal + Runtime | Planned | `evidence/integration/IT-TERM-001/` | 2026-08-15 |
