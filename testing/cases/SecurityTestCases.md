...
| SEC-SBX-001 | SEC-SBX | Validate sandbox escape resistance and Android app-private storage/overlay integrity; diagnostic inputs for ABI/assets, mount/proot readiness, storage/quota, rootfs/overlay integrity, and egress are classified with retained device/emulator evidence, and failed/unavailable/unverified conditions fail closed through existing Full Environment reset/re-extraction, PermissionModel, checkpoint, Workspace, degradation, or failure paths without a repair manager or lifecycle | Security + Sandbox | Planned | `evidence/security/SEC-SBX-001/` | 2026-08-04 |
