...
| SEC-PERM-041 | SEC-PERM | ASK/DENY-default satisfied scope triggers SCOPE_RISK_POLICY; DEC-47 category defaults do not bypass existing high-risk gates, and sensitive-domain credential entry/transaction execution remains denied while read-only navigation/extraction is permitted | Security | Planned | `evidence/security/SEC-PERM-041/` | 2026-08-06 |
