...
| SEC-PLUGIN-001 | SEC-PLUGIN | Validate plugin activation compensation preserves isolation: verified cleanup restores the activation-origin state, while failed or unproven cleanup remains `Failed` and affected capabilities are not executable | Security + Plugin System | Planned | `evidence/security/SEC-PLUGIN-001/` | 2026-08-04 |
