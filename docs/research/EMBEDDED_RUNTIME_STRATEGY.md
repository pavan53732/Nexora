...
| 13 | Deny-by-default | High-risk scopes default to DENY; the user must explicitly grant ALLOW through the layered hierarchy (Agent → Workspace → Global → scope default) | [`security/PermissionModel.md`](../../security/PermissionModel.md) (§Deny-By-Default) |
