...
| GGUF provider execution boundary | `decisions/DEC-39-gguf-execution-boundary.md` | `requirements/CONSTRAINTS.md`, `requirements/ASSUMPTIONS.md`, `architecture/PROVIDER_SYSTEM.md`, `specs/AI_PROVIDERS.md`, `architecture/SANDBOX.md`, `security/SandboxPolicy.md` |
