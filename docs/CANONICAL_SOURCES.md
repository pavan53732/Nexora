...
| Normative 250-item research workload breadth and admission boundary | `decisions/DEC-44-normative-250-item-research-workload.md` + `requirements/NFR.md` (`NFR-SCALE-006`) | `architecture/MULTI_AGENT_SYSTEM.md` (§SA-3), `specs/EXECUTION_LIFECYCLE.md`, `models/Task.md`, `docs/PERFORMANCE_BUDGET.md`, `testing/cases/E2ETestCases.md`, `testing/PerformanceTests.md`, `docs/REQUIREMENT_COVERAGE_LEDGER.md`, `docs/TRACEABILITY.md`, `docs/FR_NFR_MAPPING.md`, `docs/DOCUMENTATION_COMPLETENESS_INVENTORY.md` |
...
| Cloud-only AI provider scope and cloud degradation policy | `decisions/DEC-41-cloud-only-ai-provider-scope.md` | `architecture/PROVIDER_SYSTEM.md`, `requirements/FR.md`, `requirements/NFR.md`, `requirements/CONSTRAINTS.md`, `requirements/ASSUMPTIONS.md`, `specs/AI_PROVIDERS.md`, provider API/protocol/SDK/model projections, `specs/AUTONOMY_STABILITY.md`, product, roadmap, environment, security, sandbox, and testing documents |
