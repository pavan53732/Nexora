...
| Retry attempt state, RetryPending durability, and process-death recovery closure | `decisions/DEC-7-retry-attempt-state.md` | `models/Execution.md`, `specs/DATABASE_SCHEMA.md`, `specs/BACKGROUND_EXECUTION.md`, `state-machines/TaskLifecycle.md`, `docs/TRACEABILITY.md` |
| Skill lifecycle and agent skill binding | `decisions/DEC-11-skill-lifecycle.md` + `architecture/RUNTIME.md` | `models/Skill.md`, `architecture/AGENT_RUNTIME.md`, `architecture/TOOL_SYSTEM.md`, `docs/TRACEABILITY.md` |
| No first-class Command artifact | `decisions/DEC-12-command-artifact.md` | `architecture/WORKFLOW_ENGINE.md`, `models/Skill.md`, `architecture/RUNTIME.md`, `docs/TRACEABILITY.md` |
...
| Autonomous operation elevation | `decisions/DEC-46-autonomous-operation-elevation.md` + existing owning canonical sources | `specs/AUTONOMY_STABILITY.md`, `models/AutonomyLearning.md`, `requirements/FR.md`, `security/PermissionModel.md`, `architecture/AGENT_RUNTIME.md`, `architecture/TOOL_SYSTEM.md`, `models/Tool.md`, `protocols/Tool-Protocol.md`, `docs/api/Tool-API.md`, `sdk/ToolSDK.md`, `registry/TOOLS.md`, `registry/SKILLS.md`, `specs/PIPES.md`, `specs/BACKGROUND_EXECUTION.md`, `ui/Components.md`, and testing/traceability documents. DEC-46 records the decision; these owners retain normative behavior. |
| Open network, free browser, sensitive-action floor, and guest packages | `decisions/DEC-47-open-network-free-browser-unrestricted-guest-packages.md` + existing owning canonical sources | `security/SandboxPolicy.md`, `specs/BROWSER.md`, `docs/SANDBOX_DEPTH.md`, `requirements/FR.md`, `requirements/NFR.md`, `security/PermissionModel.md`, `architecture/SECURITY_MODEL.md`, `specs/FULL_ENVIRONMENT.md`, `specs/PIPES.md`, `security/ThreatModel.md`, `registry/TOOLS.md`, and testing/traceability documents. DEC-47 records the creator decision, including the Option B clarification that authorization is effective-policy based rather than a global network denial; these owners retain normative behavior. |
| Retired optional capabilities | `decisions/DEC-48-retired-optional-capabilities.md` | `docs/DOCUMENTATION_COMPLETENESS_INVENTORY.md`, `docs/TRACEABILITY.md`, active feature/roadmap projections, and decision-log records. DEC-48 records the scope boundary; existing subsystem owners retain current behavior. |
| Retirement of W7 research-workload target | `decisions/DEC-49-retire-w7-research-workload-target.md` | `requirements/FR.md`, `requirements/NFR.md`, `docs/DOCUMENTATION_COMPLETENESS_INVENTORY.md`, `docs/ROADMAP.md`, `docs/CHANGELOG.md`, and traceability/coverage projections. DEC-49 records the scope boundary; existing technical resource owners retain current controls. |
...
| Mechanical architecture/dependency/documentation compliance checks | `docs/DEPENDENCY_GRAPH.md` + `standards/Documentation-Standard.md` | `docs/MODULE_BOUNDARIES.md`, `docs/CANONICAL_SOURCES.md`, `docs/TRACEABILITY.md`, `docs/REQUIREMENT_COVERAGE_LEDGER.md`, `testing/IntegrationTests.md`, `testing/EVIDENCE_CONVENTIONS.md` — checks may enforce existing canonical contracts and report findings; they cannot invent or own architecture. |
| Common verification matrix, evidence envelope, and deterministic test controls | `testing/EVIDENCE_CONVENTIONS.md` | `testing/UnitTests.md`, `testing/IntegrationTests.md`, existing unit, integration, E2E, performance, regression, security, lifecycle, context, liveness, sandbox, and Android test inventories; `requirements/NFR.md`; `docs/TRACEABILITY.md` — distinguishes requirement, implementation, test definition, tested execution, and retained executed evidence; controls are test-only. |
