...
### Added
- Architecture corrections (S12): multi-scope permission evaluation, explicit risk-based scope defaults, SECURITY_MODEL alignment, canonical Session lifecycle state machine, ExecutionStatus lifecycle ownership, ToolStatus transition semantics
