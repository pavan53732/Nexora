...
- S13 — completed permission registry, audit-source attribution, classifier ordering, Session guards, recovery identity, governance-table and planned regression-case corrections.
