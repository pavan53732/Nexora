...
| **Offline workspace continuity** | Cloud-provider outage degrades to cached/non-inference workspace operations and read-only access; no local AI inference or model files (NFR-REL-006, standing DEC-44 rule) | workspace/cache storage only |
...
### 3.6 Full Environment Requirement Matrix

| # | Requirement | Phase | Type | FR | Tools |
|---|---|---|---|---|---|
